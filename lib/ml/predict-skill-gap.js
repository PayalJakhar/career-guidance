 ...
 *   npm run ml:retrain
 */
export function predictSkillMatchScore({ experience = 0, assessments = [], role = "", targetRole = "" }) {
  const avgQuizScore =
 ...
 */
export function buildPredictionTimeline({ role = "", targetRole = "", experience = 0, assessments = [] }) {
